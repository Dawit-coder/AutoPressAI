        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {preferences ? (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">{preferences.email}</p>
                </div>
              ...
              <div className="text-center py-8">
                <p className="text-gray-300 mb-4">No preferences set yet</p>
                <Link
                  href="/select"
          ...
          <div className="bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-4">
                ...
                <>
                  {preferences.is_active ? (
                    <button
                      ...
                      className="w-full flex items-center justify-center px-4 py-3 border border-red-700 text-sm font-medium rounded-md text-red-100 bg-red-900 hover:bg-red-800 transition-colors"
                    >
                      <svg
                        className="w-5 h-5 mr-2"
                        fill="none"
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center px-4 py-3 border border-green-700 text-sm font-medium rounded-md text-green-100 bg-green-900 hover:bg-green-800 transition-colors"
                    >
                      <svg
                        className="w-5 h-5 mr-2"
                        fill="none"
              ...
              <Link
                href="/subscribe"
                className="w-full flex items-center justify-center px-4 py-3 border border-gray-600 text-sm font-medium rounded-md text-gray-100 bg-gray-700 hover:bg-gray-600 transition-colors"
              >
                <svg
                  className="w-5 h-5 mr-2"
                  fill="none"
